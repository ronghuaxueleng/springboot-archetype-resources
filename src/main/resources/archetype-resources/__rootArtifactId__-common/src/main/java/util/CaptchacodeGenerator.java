...
public class CaptchacodeGenerator {
  ...
  private static CaptchacodeGenerator utils = null;
   ...
   * @return
   */
  public static CaptchacodeGenerator getInstance() {
    if (utils == null) {
      synchronized (CaptchacodeGenerator.class) {
        if (utils == null) {
          utils = new CaptchacodeGenerator();
        }
      }
    }
    return utils;
